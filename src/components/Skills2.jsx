            ...
            <div class="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
              <div class="">
                <div class="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                  ...
                  <div class="flex-grow">
                    <h2 class="text-xl title-font font-medium mb-3">Back-end</h2>
                    <div class="grid grid-cols-2 gap-4">
                      <div class="rounded-full bg-transparent border-2 border-yellow-500 p-2 text-center">
            ...
            <div className="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
              <div class="">
                <div class="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                  ...
                  <div class="flex-grow">
                    <h2 class="text-xl title-font font-medium mb-3">Habilidades blandas</h2>
                    <div class="grid grid-cols-2 gap-4">
